        ...
        builder: (BuildContext bc) {
          return Container(
            ...
            child: Column(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.only(top: 22, left: 30,bottom: 20),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text(
                          ...
                          child: Container(
                            margin:const EdgeInsets.only(left: 16,right: 13),
                              decoration: BoxDecoration(
                                ...
                                image: const DecorationImage(image:AssetImage('assets/images/room.jpg',),fit: BoxFit.cover)
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      SvgPicture.asset('assets/images/star.svg',fit: BoxFit.cover,height: 20,width: 10,),
                       Text(
                        '4.8 (21 rating)',
                        style: TextStyle(
                            color: Colors.grey.shade600,
